...
public interface AnswerRepository extends JpaRepository<Answer, Long> {
    ...
    @Query("select new com.example.mentalCare.consultant.consulting.dto.DiagnoseResultReadRes(a.id, u.name, u.imgUrl, round(avg(adt.answer),2))" +
    ...
    List<DiagnoseResultReadRes> findAnswerAvgByTeamIdAndDate(Long teamId, LocalDate answerDate);
    ...
    List<DiagnoseResultReadRes> findAnswerAvgByConsultantIdAndDate(Long consultantId, LocalDate answerDate);
}
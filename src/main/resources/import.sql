...
insert into User(`login_id`, `login_pw`, `name`, `imgUrl`, `team_id`, `role`,`age`) values('player','{bcrypt}$2a$10$d3QK7jlUd8NI6EdHmILzfejSoF.XSlmT/eRdb9zaXuM8YuWmTdzSO','test_player', 'https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460__340.png', 1,'PLAYER',25);
insert into Player(`position`,`user_id`) values('FW',1);

insert into User(`login_id`, `login_pw`, `name`, `imgUrl`, `team_id`, `role`,`age`) values('director','{bcrypt}$2a$10$d3QK7jlUd8NI6EdHmILzfejSoF.XSlmT/eRdb9zaXuM8YuWmTdzSO','test_director', 'https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460__340.png', 1,'DIRECTOR',25);
insert into Director(`user_id`) values(2);

insert into User(`login_id`, `login_pw`, `name`, `imgUrl`, `team_id`, `role`,`age`) values('player_pending','{bcrypt}$2a$10$d3QK7jlUd8NI6EdHmILzfejSoF.XSlmT/eRdb9zaXuM8YuWmTdzSO','test_player_pending', 'https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460__340.png', 1,'PENDING',25);
